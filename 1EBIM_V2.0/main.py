            ...
            while True:
                ...
                if self.is_continue:
                    ...
                    for i, det in enumerate(pred):  # detections per image
                        ...
                        cv2.putText(im0, current_time, (40, 50), cv2.FONT_HERSHEY_SIMPLEX, 1,
                                    (255, 255, 250), 2)
                        #############################
                        ...
                        if len(det):
                            ...
                            #     # alarm_list.append(1)
                            #     push_count += 1
                            #     update_count(push_count, today, li)
...
class MainWindow(QMainWindow, Ui_mainWindow):
    def __init__(self, parent=None):
        ...
        ###这个地方是右边
        self.det_thread.send_raw.connect(lambda x: self.show_bar(self.out_video))  #颠倒顺序 原raw

        self.det_thread.send_img.connect(lambda x: self.show_image(x, self.raw_video))  #颠倒顺序
...
###################################################################
    ...
    def show_bar(label):
        try:
            ...
            statis_pic = cv2.imread('./sta.png')
            statis_pic = cv2.resize(statis_pic, (750, 600), interpolation=cv2.INTER_CUBIC)
            img_src_ = statis_pic
